...
<div style='display:flex;justify-content:center;'>
    <img src='https://quickchart.io/chart?c={type:%27doughnut%27,data:{labels:[%27Easy%27,%27Medium%27,%27Hard%27],datasets:[{data:[97,132,10]}]},options:{plugins:{doughnutlabel:{labels:[{text:%27240%27,font:{size:20}},{text:%27total%27}]}}}}' width='400'/>
</div>
